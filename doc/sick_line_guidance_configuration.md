...
| nodes / node1 / sick_device_family | "MLS" | Informs the ros driver that this can device is a MLS. Currently supported values are "OLS" or "MLS". |
...
nodes:
  node1:
    ...
    # sick_line_guidance configuration of this node:
    sick_device_family: "OLS"              # can devices currently supported: "OLS" or "MLS"
...
| nodes / node1 / sick_device_family | "OLS" | Informs the ros driver that this can device is an OLS. Currently supported values are "OLS" or "MLS". |
